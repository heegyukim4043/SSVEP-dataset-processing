...
def EEGNet(nb_classes, Chans, Samples, 
    ...
    actfunction      = Activation('softmax', name = 'softmax')(dense)
    
    return Model(inputs=input1, outputs=actfunction)
...
def ShallowConvNet(nb_classes, Chans = 64, Samples = 128, dropoutRate = 0.5):
    ...
    block1       = AveragePooling2D(pool_size=(1, (75*512)//250),
                                    strides=(1, (15*512)//250))(block1)
